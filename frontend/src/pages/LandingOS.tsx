              ...
              {!isAuthenticated ? (
                <div className="flex flex-col items-center gap-6 w-full max-w-md mx-auto">
                  ...
                  <form onSubmit={handleFormLogin} className="w-full bg-cyan-950/30 border border-cyan-500/30 backdrop-blur-xl p-6 rounded-2xl space-y-4 shadow-[0_0_30px_rgba(6,182,212,0.15)]">
                    <h3 className="text-xl font-bold text-cyan-400 mb-4 tracking-widest uppercase">New Account</h3>
                    
                    <div className="text-left">
                      <label className="text-xs font-mono text-cyan-400 block mb-1 uppercase tracking-wider">Name</label>
                      <input 
                        type="text"
                        required
                    ...
                    <button 
                      type="submit"
                      className="w-full py-3 mt-2 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-xl font-bold font-mono text-sm tracking-wider uppercase hover:opacity-90 transition-opacity shadow-[0_0_15px_rgba(6,182,212,0.4)] cursor-pointer"
                    >
                      Sign Up
                    </button>
                  </form>
